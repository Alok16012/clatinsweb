          ...
          <div className="w-[380px] flex-shrink-0 space-y-3">
            ...
            <div className="rounded-2xl p-5" style={{ background: 'rgba(255,255,255,0.07)', backdropFilter: 'blur(12px)', border: '1px solid rgba(255,255,255,0.15)' }}>
              <div className="flex items-center justify-between mb-4">
                ...
                <span className="text-xs px-2 py-0.5 rounded-full font-semibold" style={{ background: 'rgba(8,189,128,0.2)', color: '#08BD80', border: '1px solid rgba(8,189,128,0.3)' }}>{content.toppersYear}</span>
              </div>
              {toppers.map((t) => (
            ...
            <div className="rounded-2xl p-4" style={{ background: 'rgba(255,255,255,0.07)', backdropFilter: 'blur(12px)', border: '1px solid rgba(255,255,255,0.15)' }}>
              ...
              <a href={content.counsellingLink} className="mt-3 block text-center py-2.5 rounded-xl font-bold text-white text-xs hover:opacity-90 transition-all" style={{ background: '#08BD80' }}>
        ...
        <div className="relative z-10 px-4 pt-5 pb-5">
          ...
          <div className="rounded-2xl overflow-hidden" style={{ background: 'rgba(255,255,255,0.04)', border: '1px solid rgba(255,255,255,0.08)' }}>
            <div className="flex items-center justify-between px-4 py-3 border-b" style={{ borderColor: 'rgba(255,255,255,0.06)' }}>
              ...
              <span className="text-[10px] font-bold px-2 py-0.5 rounded-full" style={{ background: 'rgba(8,189,128,0.15)', color: '#08BD80' }}>{content.toppersYear}</span>
            </div>
