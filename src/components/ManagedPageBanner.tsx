  ...
  return (
    <section style={{ background: 'linear-gradient(135deg,#0D1837,#1a2744)' }} className="px-4 py-8 md:py-12">
      <div className="max-w-6xl mx-auto flex flex-col md:flex-row md:items-center md:justify-between gap-5">
        <div>
          <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full mb-3" style={{ background: 'rgba(8,189,128,0.14)', border: '1px solid rgba(8,189,128,0.28)' }}>
            <span className="w-1.5 h-1.5 rounded-full" style={{ background: '#08BD80' }} />
            <span className="text-xs font-black uppercase tracking-wider" style={{ color: '#08BD80' }}>{banner.eyebrow}</span>
          </div>
        ...
        {banner.ctaLabel && banner.ctaHref && (
          <a href={banner.ctaHref} className="inline-flex justify-center px-6 py-3 rounded-xl font-bold text-sm text-white whitespace-nowrap" style={{ background: '#08BD80' }}>
            {banner.ctaLabel}
          </a>
        )}
      </div>
